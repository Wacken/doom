...
(setq org-roam-directory (concat org-dir "references"))
...
(setq org-capture-templates
      `(("t" "Todo [inbox]" entry
        ...
        ("a" "Appointment" entry
         ...
         "* %?\n%^T\n:PROPERTIES:\n:CREATED: %U\n:END:\n" :empty-lines 1)
        ("d" "Deadline" entry
         (file+headline ,(concat org-directory "gcal.org") "Deadline")
         "* %?\nDEADLINE: %^T\n:PROPERTIES:\n:CREATED: %U\n:END:\n" :empty-lines 1)
...
(setq org-noter-notes-search-path (concat org-directory "references/books"))
#+end_src
