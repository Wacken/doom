...
(setq org-todo-keywords
      (quote ((sequence "TODO(t)" "PROJECT(p)" "NEXT(n)" "CURRENT(c)" "|" "DONE(d)")
            ...
            (alltodo "" ((org-super-agenda-groups
                          '((:name "Projects Active"
                            ...
                            (:name "Projects Archived"
                             :and (:todo "PROJECT" :tag "Project" :tag "Archive" :not (:tag "Completed"))
                             :order 10)
...
** capture
:PROPERTIES:
:ID:       a9feab6d-0b64-45d1-a084-7959a8e3beb6
:END:
#+begin_src emacs-lisp
...
(setq org-roam-capture-templates
      '(("d" "default" plain #'org-roam-capture--get-point
        ...
        ("g" "goal" plain #'org-roam-capture--get-point
         ...
         :file-name "Agenda/${slug}"
         :head "#+TITLE: ${title}\n#+CREATED: %U\n#+ROAM_TAGS: Goal %^{Status|Short-Term|Long-Term|Future}\n#+FILETAGS: Goal %^{Status|Short-Term|Long-Term|Future}\n\n"
         :unnarrowed t)))
#+end_src
